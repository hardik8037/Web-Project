      ...
      <div class="cta-content reveal-scale">
        <div class="cta-card">
          ...
          <h2 class="heading-hero" style="max-width:700px;margin:0 auto 1rem;">
            Ready to Scale<br><span class="text-gradient">Your Operations?</span>
          </h2>
          <p class="text-body-lg" style="max-width:520px;margin:0 auto 2.5rem; opacity: 0.8;">
            Join 50,000+ forward-thinking businesses automating their growth with Botzo.io. Start your free trial today — no credit card required.
          </p>
          <div class="cta-buttons">
            ...
            <a href="https://wa.me/919979100352?text=Hi!%20I'm%20interested%20in%20Botzo.io" class="btn btn-whatsapp btn-lg" target="_blank" rel="noopener noreferrer">
            ...
            <a href="/contact" class="btn btn-ghost btn-lg">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="margin-right: 0.2rem;">
